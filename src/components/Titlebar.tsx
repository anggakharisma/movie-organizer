...
export default function Titlebar() {
	return (
		<div
			...
			className="flex justify-between  items-center align-center fixed top-0 left-0 right-0 bg-gray-950 border-y-2 border-gray-800"
		>
			<h1 className="text-emerald-600 text-md font-bold ml-4">Seiri</h1>
